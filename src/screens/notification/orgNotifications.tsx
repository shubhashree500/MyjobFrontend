...
export default function OrgNotifications({navigation}:any) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Pressable onPress={() => navigation.navigate('OrganizationHomeScreen')}>
          <Image 
...
const styles = StyleSheet.create({
  ...
  tabBar: {
    ...
    left: 0,
    right: 0,
    backgroundColor: '#FFFFFF', // Optional: background color for the TabBar
